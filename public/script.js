...
function renderComprasPageHeader(){
  ...
  head.innerHTML = '<tr><th>Ações</th>' + h('Data','data') + h('Produto','produto') + h('Fornecedor','fornecedor') + h('Qtd','quantidade') + h('V.Unit','valorUnit') + h('Total','total') + h('F.Pgto','formaPagamento') + h('Venc.','vencimento') + h('Situação','situacao') + '</tr>';
}
