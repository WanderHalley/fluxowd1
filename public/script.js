...
panel.innerHTML='<div class="card"><div class="card-header"><span>Total Bruto</span></div><div class="card-value">'+formatCurrency(total)+'</div><div class="card-sub">'+list.length+' venda(s)</div></div><div class="card card-accent"><div class="card-header"><span>Total Líquido (Real)</span></div><div class="card-value text-success">'+formatCurrency(liquido)+'</div></div><div class="card"><div class="card-header"><span>Total Recebido</span></div><div class="card-value text-success">'+formatCurrency(pago)+'</div></div><div class="card"><div class="card-header"><span>Saldo Devedor Total</span></div><div class="card-value text-danger">'+formatCurrency(devendo)+'</div></div>';}
